...
exports.createNewCustomers = function( req, res){ // must select the body to be
raw=>JSON in Postman
...
exports.patchCustomersById = function( req, res){ // must select the body to be
raw=>JSON in Postman
    const {body} = req;// req.body (attribute)
...
exports.deleteCustomersByID = function( req, res){ // must select the body to be
raw=>JSON in Postman
    const {body} = req;// req.body (attribute)
    const {id} = req.params;// get id
    res.status(200).json({
